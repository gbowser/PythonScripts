...
def page_file_opening_order(pdf: PdfPages):
    ...
    box(
        ...
        0.13,
        "1. Download images",
        "Open: Erwin_s4g_image_downloader/download_s4g_images.py\n\nRead: main() -> read_galaxy_names() -> download_image()",
        COLORS["blue"],
        body_size=9.0,
    )
    box(
        ...
        "Open: Erwin_s4g_image_downloader/build_s4g_geometry_manifest.py\n\nRead: main() -> build_manifest_rows() -> read_s4g_table() -> find_image_file()",
        COLORS["blue"],
        body_size=9.0,
    )
    box(
