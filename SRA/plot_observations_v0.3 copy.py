...
Rbar = 23.75 / 0.2 * (0.2 * (19.6 * 1e3) / 206265.0)
xlims = (-1.5 * Rbar, 1.5 * Rbar)
kinematics_maps(
    name_file="NGC3627_MAPS_copt_1.05asec.fits",
...
Rbar = 35 / 0.2 * (0.2 * (19.6 * 1e3) / 206265.0)
xlims = (-1.5 * Rbar, 1.5 * Rbar)
kinematics_maps(
    name_file="NGC1566_MAPS_copt_0.80asec.fits",
...
Rbar = 95 / 0.2 * (0.2 * (19.6 * 1e3) / 206265.0)
xlims = (-1.5 * Rbar, 1.5 * Rbar)
kinematics_maps(
    name_file="NGC1365_MAPS_copt_1.15asec.fits",
