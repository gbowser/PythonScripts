...
$MTObjectsBatchScript = Join-Path $ForegroundDir "Batch tools\apply_optimised_mtobjects_all_galaxies.py"
$SEPBatchScript = Join-Path $ForegroundDir "Batch tools\batch_sep_all_galaxies.py"
