...
DEFAULT_MOVE_FACTOR = 0.8810424250595279
SPIKE_GATE_MOVE_FACTOR = 0.3
DEFAULT_MIN_DISTANCE = 0.8977031394683204
DEFAULT_GAUSSIAN_FWHM = 2.1743601462389712
...
DEFAULT_MAX_AREA = 1931
DEFAULT_MAX_ELONGATION = 16.259855431446194
...
class MTObjectsTester(tk.Tk):
    ...
    def _build_controls(self) -> None:
        ...
        self._scale(filter_frame, "max_elongation", "max_elongation (↑ = aggressive)", 1.0, 20.0, 0.25, DEFAULT_MAX_ELONGATION)
