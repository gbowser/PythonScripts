...
ax.set_position([0.03, 0.02, 0.96, 0.94])
...
ax.set_xlabel("x (kpc)", fontsize=12.5)
ax.set_ylabel("y (kpc)", fontsize=12.5)
ax.set_zlabel("z (kpc)", fontsize=12.5)
ax.set_title("Milky Way toy orbits (tilted 20°; time in Myr)", fontsize=15)
...
stage_text = ax.text2D(0.02, 0.90, "", transform=ax.transAxes, fontsize=14)
